...
public class ParquetToArrowConverter
{
    ...
    public void process(String path) throws Exception
    {
        ...
        * In case a better alternative arises, it will be included here. */
        ...
        {
            ColumnReadStoreImpl colReader = new ColumnReadStoreImpl(pageReadStore,
            ...
            while (i < size)
            {
                ...
                switch (col.getPrimitiveType().getPrimitiveTypeName())
                {
                    ...
                    case BINARY: writeBinaryColumn(colReader.getColumnReader(col),
                                                    ...
                                                    rows);
                        break;
                    default: throw new Exception("Unsupported primitive type");
                }
                i++;
            }
    ...
    private void writeLongColumn(ColumnReader cr, int dmax, FieldVector v, int rows) throws Exception
    {
    ...
    private void writeBinaryColumn(ColumnReader cr, int dmax, FieldVector v, int rows) throws Exception
    {
